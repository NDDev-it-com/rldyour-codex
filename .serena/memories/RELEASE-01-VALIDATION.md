...
## Facts
- Current rldyour-codex adapter VERSION is `1.6.2` and the matching GitHub Release tag `1.6.2` points at the pinned commit. Root `config/repositories.json` and the superproject gitlink own the current adapter HEAD.
