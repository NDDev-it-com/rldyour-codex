...
- `uv run --with pyyaml python ${CODEX_HOME:-$HOME/.codex}/skills/.system/skill-creator/scripts/quick_validate.py plugins/rldyour-rules/skills/<skill>`: validates each rules skill.
...
- `diff -qr plugins/rldyour-rules ${CODEX_HOME:-$HOME/.codex}/plugins/cache/rldyour-codex/rldyour-rules/local`: verifies system cache matches the repository plugin.
