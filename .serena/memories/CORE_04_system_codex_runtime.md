...
The installed system config currently leaves model selection to the active Codex defaults; it does not write top-level `model` or `model_reasoning_effort` keys.
