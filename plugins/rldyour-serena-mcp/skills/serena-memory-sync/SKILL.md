...
description: "Maintain fact-only Serena memories, plans, and research from verified code/diffs/tests. Use after durable changes or prompts: обнови memories, синхронизируй память."
---
