...
- `system/agents/*.toml`: managed Codex custom subagent role configs installed to `~/.codex/agents/*.toml`, with temporary specialist-MCP isolation for spawned subagents.
