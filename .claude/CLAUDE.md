...
- `scripts/install_system_codex.sh --apply` installs global Codex instructions, config sections, YOLO defaults, marketplace registration, and plugin cache.
- `scripts/doctor_system_codex.sh` verifies installed state.
